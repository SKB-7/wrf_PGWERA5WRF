...
CMIP6anom_dir_pinterp = "/mnt/hdd2/S_K_B/annualcycles_deltas_regridERA5/regrid_ERA5/ENSdelta/interp_plevs" #"/home/dargueso/BDY_DATA/CMIP6"
    ...
    for nt in range(date1, date2 + 1):
        ...
        if filewrite == True:
            ...
            for var in vars3d:
                ...
                fanom = nc.Dataset(
                    "%s/%s_CC_signal_ssp126_2070-2099_1985-2014_pinterp.nc"
                    % (CMIP6anom_dir_pinterp, var)
                )
            ...
            for var in vars2d:
                ...
                fanom = nc.Dataset(
                    "%s/%s_CC_signal_ssp126_2070-2099_1985-2014.nc"
                    % (CMIP6anom_dir, var)
                )
            ...
            fields2d[0, :, :] = np.float32(vout["hurs"])
            fields2d[1, :, :] = np.float32(vout["ps"])
